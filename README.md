...
1. Git clone https://github.com/PostyZZZ/Mylaba3.git
...
Запустив приложение вам будут доступны 1 кнопка:
Добавить, после нажатия открывается окно для заполнения данных и кнопка добавить.
На основной активити список из БД, при нажатии на ячейку, будет открыто меню с кнопками "Удалить и Сохранить"
